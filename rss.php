...
function getFeed($url)
{
    ...
    if ($rss->entry) {
        foreach ($rss->entry as $item) {
            ...
            $html .= '<li><a  target="_blank" href="' . htmlspecialchars($item->link->attributes()) . '" >' . htmlspecialchars(
                    $item->title
                ) . '</a></li>';
        }
    }
    ...
    if ($rss->channel->item) {
        foreach ($rss->channel->item as $item) {
            ...
            $html .= '<li><a target="_blank" href="' . htmlspecialchars($item->link) . '">' . htmlspecialchars(
                    $item->title
                ) . '</a></li>';
        }
    }
